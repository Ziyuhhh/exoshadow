...
echo Running LCO-ONLY (NO PRIOR)...
python phot_var_twin_sine_QC_v12_mcmc.py aavsodata_6a4c76862af39.csv ^
  --delim comma ^
  ...
  --outdir phot_var_runs_noprior/WASP-52_LCO ^
  --ic-mode gauss

echo Running EPW-ONLY (NO PRIOR)...
python phot_var_twin_sine_QC_v12_mcmc.py aavsodata_6a4c76862af39.csv ^
  --delim comma ^
  --time-col JD --mag-col Magnitude --mag-err-col Uncertainty ^
  --observer-col "Observer Code" --filter-col Band --band-include V ^
  ...
  --exclude-periods "0.95-1.05;1.60-1.90;1.90-2.10" ^
  --mcmc --mcmc-walkers 64 --mcmc-steps 12000 --mcmc-burn 3000 --mcmc-thin 5 --mcmc-period-prior-k 3.0 --mcmc-seed 42 --mcmc-moves de ^
  --outdir phot_var_runs_noprior/WASP-52_EPW ^
  --ic-mode gauss

echo Running ALL - NO PRIOR (LCO + EPW)...
python phot_var_twin_sine_QC_v12_mcmc.py aavsodata_6a4c76862af39.csv ^
  --delim comma ^
  --time-col JD --mag-col Magnitude --mag-err-col Uncertainty ^
  --observer-col "Observer Code" --filter-col Band --band-include V ^
  ...
  --exclude-periods "0.95-1.05;1.60-1.90;1.90-2.10" ^
  --mcmc --mcmc-walkers 64 --mcmc-steps 12000 --mcmc-burn 3000 --mcmc-thin 5 --mcmc-period-prior-k 3.0 --mcmc-seed 42 --mcmc-moves de ^
  --outdir phot_var_runs_noprior/WASP-52_all ^
  --ic-mode gauss

echo Running ARCHIVED (NO PRIOR)...
python phot_var_twin_sine_QC_v12_mcmc.py aavsodata_6a4c76862af39.csv ^
  --delim comma ^
  --time-col JD --mag-col Magnitude --mag-err-col Uncertainty ^
  --observer-col "Observer Code" --filter-col Band --band-include V ^
  ...
  --exclude-periods "0.95-1.05;1.60-1.90;1.90-2.10" ^
  --mcmc --mcmc-walkers 64 --mcmc-steps 12000 --mcmc-burn 3000 --mcmc-thin 5 --mcmc-period-prior-k 3.0 --mcmc-seed 42 --mcmc-moves de ^
  --outdir phot_var_runs_noprior/WASP-52_archived ^
  --ic-mode gauss

echo Running comparison script (NO PRIOR)...
cd phot_var_runs_noprior
...
python v10_compare_runs_to_overleaf_mcmc.py ^
  ...
  --outdir compare_WASP-52_noprior
